...
%    p.predFilename = 'preds/reference/bearpaw-hg_s8_b1.mat';
  ...
  case 4
    p.name = 'TF; Boxsize = 128';
    
    p.predFilename = 'preds/pred_valid_tf_128_20180228170900.h5'; 
  case 5
    p.name = 'TF; Boxsize = 192';
    
    p.predFilename = 'preds/pred_valid_tensorflow_192_20180305202152.h5';
  case 6
    p.name = 'TF; Boxsize = 328';
    
    p.predFilename = 'preds/pred_valid_tensorflow_192_20180305195830.h5'; 
end
